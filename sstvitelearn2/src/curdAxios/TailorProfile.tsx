...
export default function ProfileTailor() {
  ...
  const [tailor, setTailor] = useState<TailorType>({
    personal: {
      emailid: "",
      name: "",
      contact: "",
  ...
  const [prevAadharBack, setPrevAadharBack] = useState<string | null>(null); // ✅ NEW
  ...
  function updatePicAndSetPreview(
    ...
    type: "profilePic" | "aadharCard" | "aadharBack"
  ) {
    ...
    if (type === "profilePic") {
      ...
      setPrevAadhar(previewUrl);
    }
    else {
      setPrevAadharBack(previewUrl);
    }
  }
  ...
  async function handleExtractAadhar() {
    ...
    const front = tailor.personal.aadharCard;
    const back = tailor.personal.aadharBack;

    if (!front || !back) {
      alert("Please upload front and back Aadhaar");
      setLoading(false);
      return;
    }
    ...
    formData.append("aadharCard", front);
    formData.append("aadharBack", back);
  ...
  const handleSubmit = async () => {
    ...
    // ✅ NEW
    if (tailor.personal.aadharBack)
      frmData.append("aadharBack", tailor.personal.aadharBack);
  ...
  async function doFind() {
    ...
    setTailor({
      personal: {
        ...
        aadharBack: doc.aadharBack || null, // ✅ NEW
      },
      professional: {
    ...
    // ✅ NEW
    setPrevAadharBack(doc.aadharBack);
  }
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <p className="font-semibold">
                  {tailor.personal.name || "Name"}
                </p>

                <p className="text-sm text-gray-400">
                  {tailor.personal.emailid}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <label className="block cursor-pointer">
                ...
                <input
                  ...
                  accept="image/*"
                  className="hidden"
                  onChange={(e) => updatePicAndSetPreview(e, "aadharBack")}
                />
              ...
              {prevAadharBack && (
                <div className="mt-3 flex justify-center">
                  <img
                    src={prevAadharBack}
                    className="w-52 h-32 object-cover rounded-lg border border-green-500"
                  />
                </div>
              )}
